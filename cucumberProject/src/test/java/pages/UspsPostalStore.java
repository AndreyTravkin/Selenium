...
public class UspsPostalStore extends Page {
    ...
    private WebElement sectionExists;

    @FindBy(xpath = "//input[@id='store-search']")
    private WebElement postalStoreSearchField;

    @FindBy(xpath = "//input[@id='store-search-btn']")
    private WebElement postalStoreSearchButton;
    ...
    public void clickPostalStoreSearchButton(){
        postalStoreSearchButton.click();
    }

    public void typeIntoSearchField(String value) {
        postalStoreSearchField.sendKeys(value);
    }

    public String getSectionExists(){
        return sectionExists.getText();
    }
